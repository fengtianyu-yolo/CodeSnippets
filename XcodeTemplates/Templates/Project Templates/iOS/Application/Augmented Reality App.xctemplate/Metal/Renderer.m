...
- (void)_loadMetal {
    ...
    capturedImagePipelineStateDescriptor.rasterSampleCount = _renderDestination.sampleCount;
    ...
    anchorPipelineStateDescriptor.rasterSampleCount = _renderDestination.sampleCount;
